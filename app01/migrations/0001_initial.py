# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-07-10 09:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_type_id', models.IntegerField(choices=[(1, 'Python'), (2, 'Linux'), (3, 'OpenStack'), (4, 'GoLang')], default=None, verbose_name='文章类型')),
            ],
        ),
        migrations.CreateModel(
            name='Article2Tag',
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Category', verbose_name='文章个人类型'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
